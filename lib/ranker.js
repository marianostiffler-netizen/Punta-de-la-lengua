 ...
 * @param {Object} analysis - Análisis original del query
 * @returns {Array} Resultados ordenados por relevancia
 */
export function rankResults(results, analysis = {}) {
 ...
 */
export function groupByArtist(results) {
  return results.reduce((groups, song) => {
